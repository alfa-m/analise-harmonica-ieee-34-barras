...
matrizes_diagonais = procura("matriz_diagonal_real*.csv", "./")
...
for matriz in matrizes_diagonais:
    ...
    valores_maximos.to_csv("./z_modal_caso1_frequencia_{}".format(frequencia_atual))
...
print("Modos críticos encontrados e salvos no arquivo 'modos_criticos_y_caso1.csv'")
