...
def plota_vmag(dados_barra, nome_barra):
    ...
    plt.ylabel("Tensão (V)")
    plt.title("Medição na barra {} com fonte harmônica no nó 802.1".format(nome_barra))
    plt.grid()
    plt.savefig("../figuras/vmag_caso1_no_802_1_barra_{}_sem_eixo.png".format(nome_barra))
    plt.show()
    plt.close()
    plt.pause(1)
    ...
    plt.title("Medição na barra {} com fonte harmônica no nó 802.1".format(nome_barra))
    plt.grid()
    plt.savefig("../figuras/vmag_caso1_no_802_1_barra_{}_total.png".format(nome_barra))
    plt.show()
    plt.close()
    plt.pause(1)
    ...
    plt.title("Medição na barra {} com fonte harmônica no nó 802.1".format(nome_barra))
    plt.grid()
    plt.savefig("../figuras/vmag_caso1_no_802_1_barra_{}_harmonico_1.png".format(nome_barra))
    plt.show()
    plt.close()
    plt.pause(1)
    ...
    plt.title("Medição na barra {} com fonte harmônica no nó 802.1".format(nome_barra))
    plt.grid()
    plt.savefig("../figuras/vmag_caso1_no_802_1_barra_{}_harmonico_2.png".format(nome_barra))
    plt.show()
    plt.close()
    plt.pause(1)
