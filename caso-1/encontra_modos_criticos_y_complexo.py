...
for matriz in matrizes_diagonais:
    ...
    valores_maximos.to_csv("./z_complexa_modal_caso1_frequencia_{}".format(frequencia_atual))
...
modos_criticos.to_csv('./modos_criticos_y_complexa_caso1.csv')
print("Modos críticos encontrados e salvos no arquivo 'modos_criticos_y_complexa_caso1.csv'")
